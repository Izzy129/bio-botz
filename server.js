...
wss.on('connection', function connection(ws) {
	ws.on('message', function incoming(message) {
		...
		console.log(`Client connected and movement packet connect! START BOTS!`.red); //log if bots can move or not yet
		let off = 1;
		switch (opcode) {
			...
			case 0xff: //encrypted opcode
				...
				console.log('Bots started at' + ip, 'Bot amount:' + amount);
